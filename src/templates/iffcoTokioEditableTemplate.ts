  ...
  blocks: [
    ...
    },
    {
      ...
      meta: JSON.stringify({
        ...
        bullets: [
          { title: "Scheduled learning nudges", text: "automatically push reminders to agents before renewal seasons or product launches", check: "teal" },
          { title: "Course completion reminders", text: "reduce drop-offs with timely, automated follow-ups", check: "teal" },
          { title: "Automated communication sequences", text: "run targeted engagement campaigns without manual effort", check: "teal" },
        ],
      }),
    },
    {
      ...
      meta: JSON.stringify({
        ...
        subtitle: "A short-form content feed — built like Reels or Shorts — so your teams consume knowledge in the format they already love.",
        bullets: [
          { title: "Video explainers", text: "short-form content on insurance products, policy terms, and claims processes", check: "navy" },
          { title: "Compliance refreshers", text: "quick refreshers in a swipeable, engaging format", check: "navy" },
          { title: "Higher engagement", text: "better engagement rates vs traditional e-learning modules", check: "navy" },
        ],
      }),
    },
    {
