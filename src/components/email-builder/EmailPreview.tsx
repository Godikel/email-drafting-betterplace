...
function checkCircle(background: string, color: string): string {
  return `<span style="display:inline-block;width:18px;height:18px;border-radius:999px;background:${background};vertical-align:middle;text-align:center;line-height:18px;color:${color};font-size:12px;font-weight:700;font-family:Arial,sans-serif;">&#10003;</span>`;
}
